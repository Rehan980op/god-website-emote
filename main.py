            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f'Hi! I am a bot from God'
...
async def MaiiiinE():
    ...
    Uid , Pw = '4209661907','C415C49E479A2281C759DE65E9E81961D2AB240B8D0A69F912EE00079B666797'
    ...
    print(render('God', colors=['white', 'red'], align='center'))
    print(f" - BoT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | God ! (:")    
    print(f" - SCRIPT BY > God ! (:")    
